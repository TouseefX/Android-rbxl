...
impl TextEdit<'_> {
    ...
    fn show_content(self, ui: &mut Ui) -> TextEditOutput {
        ...
        // A focused desktop editor uses dragging for selection. On touch,
        // however, claiming drag here prevents an enclosing ScrollArea from
        // ever receiving a swipe once the software keyboard has focused this
        // TextEdit. Mobile selection starts with a long-press (handled by
        // TextCursorState), while ordinary drags remain smooth kinetic pans.
